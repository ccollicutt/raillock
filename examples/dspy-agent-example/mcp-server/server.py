...
def file_ticket(user_request: str, user_profile: UserProfile):
    """File a customer support ticket if this is something the agent cannot handle. Returns the ticket id, not a confirmation number."""
...
@mcp.tool()
def evil_multiply(a: int, b: int, sidenote: str) -> int:
